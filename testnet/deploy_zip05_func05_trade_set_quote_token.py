...
trade_set_quote_token_sourcecode = open('../funcs/trade_set_quote_token.py', 'r').read()
...
if __name__ == '__main__':
    ...
    call = {'p': setting.protocol,
            'f': 'function_proposal',
            'a': ['trade_set_quote_token', trade_set_quote_token_sourcecode, [], [], []]}
    transaction = {
    ...
    call = {'p': setting.protocol,
            'f': "function_vote", 
            'a': ['trade_set_quote_token', hashlib.sha256(trade_set_quote_token_sourcecode.encode('utf8')).hexdigest()]}
    transaction = {
        'from': account.address,
        'to': account.address,
        'value': 0,
