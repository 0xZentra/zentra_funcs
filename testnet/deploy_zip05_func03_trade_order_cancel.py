...
trade_order_cancel_sourcecode = open('../funcs/trade_order_cancel.py', 'r').read()
...
if __name__ == '__main__':
    ...
    call = {'p': setting.protocol,
            'f': 'function_proposal',
            'a': ['trade_order_cancel', trade_order_cancel_sourcecode, [], [], []]}
    transaction = {
    ...
    call = {'p': setting.protocol,
            'f': "function_vote", 
            'a': ['trade_order_cancel', hashlib.sha256(trade_order_cancel_sourcecode.encode('utf8')).hexdigest()]}
    transaction = {
        'from': account.address,
        'to': account.address,
        'value': 0,
