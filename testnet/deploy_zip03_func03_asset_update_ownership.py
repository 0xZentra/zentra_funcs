...
asset_update_ownership_sourcecode = open('../funcs/asset_update_ownership.py', 'r').read()
...
if __name__ == '__main__':
    ...
    call = {'p': setting.protocol,
            'f': 'function_proposal',
            'a': ['asset_update_ownership', asset_update_ownership_sourcecode, [], [], []]}
    transaction = {
    ...
    call = {'p': setting.protocol,
            'f': "function_vote", 
            'a': ['asset_update_ownership', hashlib.sha256(asset_update_ownership_sourcecode.encode('utf8')).hexdigest()]}
    transaction = {
        'from': account.address,
        'to': account.address,
        'value': 0,
